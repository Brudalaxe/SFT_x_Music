...
parser.add_argument("--data_dir", type=str, default="/import/c4dm-05/bja01/models/splitfinetuning/data/MRPC")
parser.add_argument("--save_path", type=str, default="mrpc.pt")
parser.add_argument("--log_path", type=str, default="mrpc.log")
...
args.train_path = os.path.join(args.data_dir, "msr_paraphrase_train.txt")
args.dev_path = os.path.join(args.data_dir, "msr_paraphrase_test.txt")
