...
parser.add_argument("--data_dir", type=str, default="/import/c4dm-05/bja01/models/splitfinetuning/data/MNLI")
parser.add_argument("--save_path", type=str, default="mnli.pt")
parser.add_argument("--log_path", type=str, default="mnli.log")
...
args.dev_path = os.path.join(args.data_dir, "dev_matched.tsv")
