...
parser.add_argument("--data_dir", type=str, default="/import/c4dm-05/bja01/models/splitfinetuning/data/QNLI")
parser.add_argument("--save_path", type=str, default="qnli.pt")
parser.add_argument("--log_path", type=str, default="qnli.log")
